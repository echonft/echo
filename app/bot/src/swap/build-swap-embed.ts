...
export function buildSwapEmbed(offer: Offer, creator: UserDocumentData) {
  return (
    new EmbedBuilder()
      .setTitle(i18next.t('swap.embed.title'))
      .setDescription(i18next.t('swap.embed.description', { user: userMention(creator.discord.id) }))
