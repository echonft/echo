...
export type CancelNftOffersTaskData = NftIndex

export async function cancelNftOffersTask(nft: NftDocument): Promise<Task<CancelNftOffersTaskData>> {
  const name = CloudFunctionName.CancelNftOffers
