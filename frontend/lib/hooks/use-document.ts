...
import { getFirebaseDocSnapshotFromPath } from '@echo/firebase/getters/get-document'
import { failureResult, Result, successfulResult, SwrResult } from '@lib/models/result'
