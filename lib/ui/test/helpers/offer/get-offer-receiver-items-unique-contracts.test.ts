import { getOfferReceiverItemsUniqueContracts } from '@echo/ui/helpers/offer/get-offer-receiver-items-unique-contracts'
...
describe('helpers - offer - getOfferReceiverItemsUniqueContracts', () => {
  it('returns the contract if there is only 1 contract', () => {
    ...
    const contracts = getOfferReceiverItemsUniqueContracts(offer)
  ...
  it('returns 2 contracts if there are 2 different contracts in the offer items', () => {
    ...
    const offer = {
      receiverItems: [offerItem1, offerItem2, offerItem1, offerItem2]
    } as unknown as Offer
    const contracts = getOfferReceiverItemsUniqueContracts(offer)
