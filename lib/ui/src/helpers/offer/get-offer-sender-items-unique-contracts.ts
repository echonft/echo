...
export function getOfferSenderItemsUniqueContracts(offer: Offer): NonEmptyArray<Contract> {
  // eslint-disable-next-line @typescript-eslint/ban-ts-comment
  // @ts-ignore
  return pipe(prop('senderItems'), map(path(['nft', 'collection', 'contract'])), uniq<Contract>)(offer)
}
