...
export const CollectionSelectorCollectionPicture: FunctionComponent<Props> = ({ src, alt }) => {
  ...
  return (
    ...
    >
      <ImageSizeable
        className={clsx('select-none', 'rounded-2xl', 'bg-dark-500', 'object-center', 'object-contain')}
        width={57}
        height={57}
        src={src}
        alt={alt}
      ...
      {loaded ? (
        <div
          className={clsx('absolute', 'rounded-2xl', 'inset-0', 'bg-gradient-to-b', 'from-transparent', 'to-black')}
        />
      ) : (
