import { NewListingSliderSearchBoxOptions } from './new-listing-slider-search-box-options'
  ...
  return (
    <Combobox value={selectedOptions} onChange={onSelectionChange} name={name} multiple>
      ...
      >
        ...
        >
          <NewListingSliderSearchBoxOptions options={options} selectedOptions={selectedOptions} searching={searching} />
        </Combobox.Options>
      </Transition>
    </Combobox>
  )
