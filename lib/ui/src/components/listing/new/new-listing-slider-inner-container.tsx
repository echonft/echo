import { NewListingSliderItemsContainer } from './new-listing-slider-items-container'
...
export const NewListingSliderInnerContainer: FunctionComponent<Props> = ({
  ...
  return (
    <div className={clsx('flex', 'flex-col', 'gap-6', 'py-3', 'pb-32')}>
      ...
      <NewListingSliderItemsContainer items={items} onAddMore={onAddMoreItem} onRemove={onRemoveItem} />
