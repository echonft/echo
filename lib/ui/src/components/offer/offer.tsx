...
export const Offer: FunctionComponent<OfferProps> = ({ offer, receiver, isReceiver }) => {
  return (
    <div
      className={clsx(
        'flex',
    ...
    >
      <OfferInfoContainer state={offer.state} discordUsername={receiver.discordUsername} />
