import { FirestoreNftData } from '../../../src/types/model/data/nft/firestore-nft-data'
import { nftCollectionFirestoreData } from '../nft-collection/nft-collection-firestore-data'
