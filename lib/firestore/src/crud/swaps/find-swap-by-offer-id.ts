...
export async function findSwapByOfferId(offerId: string): Promise<FirestoreSwap | undefined> {
  ...
  return (head(querySnapshot.docs) as QueryDocumentSnapshot<FirestoreSwap>).data()
}
