import { CreateDiscordRequest } from '../../src/types'
...
import { mockAddDiscordGuildAndContracts } from '../../src/utils/test/mocks/firebase-admin/add-discord-guild-and-contracts'
