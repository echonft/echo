...
import { RequestForOfferRequest } from '../../src/types/model/requests/request-for-offer-request'
...
describe('handlers - user - cancelRequestForOfferHandler', () => {
  ...
  it('if findRequestForOfferById throws, returns 401', async () => {
    const { req, res } = mockRequestResponse<RequestForOfferRequest, never, RequestForOfferResponse>('GET', undefined, {
      id: 'throw'
    })
