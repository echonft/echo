import { walletEquals } from '../../../../ui-model'
...
import { findNonceForUser, findUserByWallet, FirestoreUserData, FirestoreWalletData } from '@echo/firestore'
      ...
      return siweMessage
        ...
        .then((response) => {
          ...
          return findNonceForUser(user.id)
            .then((foundNonce) => {
              if (isNilOrEmpty(data.nonce) || data.nonce !== foundNonce.nonce) {
