...
describe('mappers - mapOfferToOfferSignature', () => {
  ...
  it('maps correctly multiple items', () => {
    ...
    const expected = {
      id: 'offer-id',
      expiresAt: 2324074781,
      creator: formatAddress({ address: toLower('0x213bE2f484Ab480db4f18b0Fe4C38e1C25877f09') }),
      counterparty: formatAddress({ address: toLower('0x1E3918dD44F427F056be6C8E132cF1b5F42de59E') }),
      creatorIds: [2, 1],
      creatorCollections: [
        formatAddress({ address: toLower('0x213Be2F484ab480dB4F18b0Fe4C38e1c25877f09') }),
        formatAddress({ address: toLower('0x320e2fa93A4010ba47edcdE762802374bac8d3F7') })
      ],
