...
export const EVM_TESTNET_CHAIN_NAMES = [TESTNET_CHAIN_BLAST, TESTNET_CHAIN_SEPOLIA] as const
...
// Blast only for now
export const SUPPORTED_CHAINS = isTestnet ? [TESTNET_CHAIN_BLAST] : [CHAIN_BLAST]
